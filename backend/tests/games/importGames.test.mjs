...
import { importGames } from '../../games/importGames.js';
import Game from '../../games/gameModel.js';
...
describe('Import Games', () => {
  ...
  it('should import 555 games from small.pgn', async () => {
    try {
